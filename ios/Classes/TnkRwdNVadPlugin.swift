...
public class TnkRwdNVadPlugin: NSObject, FlutterPlugin, OfferwallEventListener
{
        ...
        case "onItemClick":
            if let args = call.arguments as? [String: Any] {
                if let placement_id = args["app_id"] as? String {
                    TnkRwdNVadPlugin.placementView?.clickItem(
                        appid: placement_id
                    ) { issuccess, error in
                        if issuccess {
                            result(
        ...
        case "getPlacementJsonData":
            if let args = call.arguments as? [String: Any] {
                if let placement_id = args["placement_id"] as? String {
                    TnkRwdNVadPlugin.placementView =
                    ...
                    TnkRwdNVadPlugin.placementView!.loadItem()
                } else {
                    result("fail")
                }
            }
...
//            {
//
//                TnkRwdNVadPlugin.tnkCustomUI.setCustomUIDefault(
//                    param: map
//                )
//                result("success")
//
...
//            }
    ...
    public func didOfferwallRemoved() {
        print("closed")
        TnkRwdNVadPlugin.channel?.invokeMethod(
            "didOfferwallRemoved",
            arguments: "success"
        )
    }
...
extension TnkRwdNVadPlugin : AdiscopeDelegate {
    //InterStitial
