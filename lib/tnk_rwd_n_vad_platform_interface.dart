...
import 'tnk_rwd_n_vad_method_channel.dart';

abstract class TnkRwdNVadPlatform extends PlatformInterface {
  /// Constructs a TnkRwdNVadPlatform.
  TnkRwdNVadPlatform() : super(token: _token);

  static final Object _token = Object();

  static TnkRwdNVadPlatform _instance = MethodChannelTnkRwdNVad();

  /// The default instance of [TnkRwdNVadPlatform] to use.
  ///
  /// Defaults to [MethodChannelTnkRwdNVad].
  static TnkRwdNVadPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [TnkRwdNVadPlatform] when
  /// they register themselves.
  static set instance(TnkRwdNVadPlatform instance) {
